...
export const HeartTree = ({ delay = 1000 }: HeartTreeProps) => {
    ...
    return (
        // ── Card container: intentional borders + shadow, not an exposed div ──
        <div
        ...
        >
            ...
            >
                {/* Soft inner vignette so tree edges dissolve into the card */}
                <div
                ...
                >
                    ...
                    >
                        <defs>
                            ...
                            {/* Leaf gradient so hearts have a top-lit look */}
                            <radialGradient id="leafGrad" cx="40%" cy="30%" r="60%">
                                <stop offset="0%" stopColor="white" stopOpacity="0.25" />
                                <stop offset="100%" stopColor="black" stopOpacity="0.15" />
                            </radialGradient>

                            {/* Inner glow filter for stage-4 hearts */}
